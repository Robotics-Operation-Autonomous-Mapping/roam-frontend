        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-12 mb-16">
          ...
          <div className="flex-1 text-center max-w-xl mx-auto lg:mx-0">
            <p className="font-display text-2xl md:text-3xl tracking-wide text-cream leading-tight">
              &quot;ROAM IS NOT JUST A CLUB. IT IS A LAUNCHPAD FOR BUILDERS.&quot;
            </p>
          </div>
          ...
          <div className="flex flex-col items-center lg:items-end gap-6 text-center lg:text-right">
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/schulichroam/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-border flex items-center justify-center hover:border-primary hover:text-primary transition-colors group">
              ...
              <a href="https://www.linkedin.com/company/schulichroam/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-border flex items-center justify-center hover:border-primary hover:text-primary transition-colors group">
              ...
              <a href="https://github.com/schulichroam" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-border flex items-center justify-center hover:border-primary hover:text-primary transition-colors group">

...
const AutonomousCar: React.FC<{
  ...
  useFrame((_, delta) => {
    ...
    const b = new THREE.Vector3(
      ...points[(segmentRef.current + 1) % (points.length - 1)],
    );
...
const Scene: React.FC<{
  ...
  return (
    <>
      ...
      <gridHelper
        args={[GRID_SIZE, GRID_SIZE, "#E8512A", "#333840"]}
        position={[0, 0, 0]}
      />
      <mesh
    ...
    <section className="max-w-7xl mx-auto px-6 w-full mb-24">
      <div className="mb-6">
        ...
        <p className="font-sans text-cream/75 max-w-3xl leading-relaxed">
          This simulation runs A* path planning over a constrained map and
          continuously drives a rover along the computed trajectory.
        </p>
      </div>

...
export const RigMesh: React.FC<Props> = ({ part, activeId, setActiveId }) => {
  ...
  const inner = (() => {
    switch (part.id) {
      case "lidar":
        return <LidarMesh mats={mats} isActive={isActive} />;
      case "stereo_cam":
        return <StereoCamMesh mats={mats} />;
      case "radar":
        return <RadarMesh mats={mats} />;
      case "rtk_gps":
        return <RtkGpsMesh mats={mats} />;
      case "compute":
        return <ComputeMesh mats={mats} isActive={isActive} />;
      case "battery":
        return <BatteryMesh mats={mats} />;
      case "pdb":
        return <PdbMesh mats={mats} />;
      case "esc":
        return <EscMesh mats={mats} />;
      case "imu":
        return <ImuMesh mats={mats} />;
      case "comms":
        return <CommsMesh mats={mats} />;
      case "estop":
        return <EstopMesh mats={mats} isActive={isActive} />;
      default:
        return null;
    }
  })();
  ...
  return (
    ...
    >
      ...
      {isActive && (
        <PartRings
          ringRadius={part.ringRadius}
          color={CATEGORY_COLOR[part.category]}
        />
      )}
    </group>
  );

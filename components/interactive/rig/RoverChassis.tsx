  ...
  return (
    <group position={[0, 0.15, 0.15]} scale={1.7}>
      ...
      {[
        ...
        <mesh
          key={`br${i}`}
          position={[b.x * 0.55, BOT_Y + 0.35, b.z]}
          rotation={[0, b.ry, b.rz]}
          material={frameMat}
        >
      ...
      <mesh position={[-0.3, TOP_Y + 0.55, -0.5]} material={frameMat}>
        <cylinderGeometry args={[0.018, 0.02, 1.1, 10]} />
      </mesh>
    </group>
  );
};

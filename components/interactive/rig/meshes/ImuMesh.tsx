...
export const ImuMesh: React.FC<Props> = ({ mats }) => (
  <group>
    ...
    <mesh position={[0, 0.035, 0]} material={mats.pcbMat}>
      <boxGeometry args={[0.18, 0.005, 0.18]} />
    </mesh>
    <mesh position={[0, -0.045, 0]} material={mats.chassisMat}>
    ...
    {[
      ...
      <mesh key={i} position={[x, -0.04, z]} material={mats.goldMat}>
    ...
    <mesh position={[0, 0.038, 0.05]} material={mats.accentMat}>
      <boxGeometry args={[0.005, 0.002, 0.06]} />
    </mesh>
    <mesh position={[0.05, 0.038, 0]} material={mats.accentMat}>
